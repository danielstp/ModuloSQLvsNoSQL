...
class CategoryFilmInline(admin.StackedInline):
    model = FilmCategory
...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ("name", "countFilms")
    list_filter = ("last_update",)
    search_fields = ("name",)
    inlines = [CategoryFilmInline]
...
class CustomerAdmin(admin.ModelAdmin):
    ...
    list_filter = ("store", "address", "create_date", "last_update", "active")
